...
def upgrade():
    ...
    op.add_column("enrolments", sa.Column("wins", sa.Integer))
    op.add_column("enrolments", sa.Column("defeats", sa.Integer))
...
def downgrade():
    ...
    op.drop_column("enrolments", "wins")
    op.drop_column("enrolments", "defeats")
